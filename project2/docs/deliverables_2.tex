...
target, but shapes, values and timeing looks OK. \\


\textbf{Spike-Train \#4} \\
Looks good in convergance of the fitness at the beginning of the run, but stagnates quickly and stays unchanged later on. 
The result share the same traits as the prevouis spike-trains. \\
